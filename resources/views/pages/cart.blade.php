                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5">
                            <p>
                                ...
                                {{--                                <b>With Discount: </b>KES {{ \Cart::get($item->id)->getPriceSumWithConditions() }}--}}
                            </p>
                        </div>
                        <div class="col-lg-4">
                            <div class="row">
                                <form action="{{ route('cart.update') }}" method="POST">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <input type="number" class="form-control form-control-sm" value="{{ $item->quantity }}"
                                               id="quantity" name="quantity" style="width: 70px; margin-right: 10px; margin-left: 10px;">
                                        <button class="btn btn-secondary btn-sm" style="margin-right: 25px;"><span class="ion-ios-edit">Update</span></button>
                                    </div>
                                </form>
